...
export const getProducts=(params)=>(dispatch)=>{
    ...
    axios.get(`https://red-violet-salmon-wrap.cyclic.app/freshrecomentation?_limit=${params}`)
...
export const getSingelProduct=({category,id})=>(dispatch)=>{
    ...
    axios.get(`https://red-violet-salmon-wrap.cyclic.app/${category}/${id}`)
...
export const postData=(payload)=>(dispatch)=>{
    ...
    return axios.post("https://red-violet-salmon-wrap.cyclic.app/cars",payload)
